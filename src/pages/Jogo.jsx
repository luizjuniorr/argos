            ...
            <div className="flex flex-col md:flex-row h-screen justify-center items-center gap-16 max-w-6xl mx-auto py-16 px-4 ">
                <div className="flex flex-col justify-center items-center md:items-start w-full md:w-1/2">
                    <div className="flex justify-center items-center gap-3 mb-6">
                        <h1 className="font-strike text-dark-green text-3xl md:text-6xl text-center md:text-left dark:text-white">Argos Game</h1>
                        <img src={theme === "dark" ? icon_jogo_escuro : icon_jogo} alt="" className="w-8 md:w-12" />
                    </div>
                    ...
                    <button className="bg-dark-green w-3/5 h-8 md:w-full rounded-xl text-white font-strike cursor-pointer">Jogar</button>
                </div>
