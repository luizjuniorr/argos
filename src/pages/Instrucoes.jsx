        ...
        <div className="">
            ...
            <div className="">
                ...
                <div className="bg-white dark:bg-dark-mode flex flex-col justify-center items-center pb-2">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/CKsBOYL5Qek?si=6tP2ov9X81QL2A1i" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
